...
function assertSelectionSetForIdValue(store, field, fieldValue) {
  if (!field.selectionSet) {
    ...
    workSet_1.forEach(function(value) {
      if (isNonNullObject(value)) {
        invariant2(!isReference(value), 10, getTypenameFromStoreObject(store, value), field.name.value);
    ...
    ObservableQuery2.prototype.refetch = function(variables) {
      ...
      if (globalThis.__DEV__ !== false && variables && hasOwnProperty7.call(variables, "variables")) {
        ...
        if (!vars || !vars.some(function(v) {
          ...
          globalThis.__DEV__ !== false && invariant2.warn(20, variables, ((_a2 = queryDef.name) === null || _a2 === void 0 ? void 0 : _a2.value) || queryDef);
        }
      }
    ...
    QueryManager2.prototype.getObservableFromLink = function(query, context, variables, extensions, deduplication) {
      ...
      if (serverQuery) {
        ...
        if (deduplication) {
          ...
          if (!observable) {
            var concast = new Concast([execute2(link, operation)]);
...
var ApolloClient = (
  ...
  function() {
    function ApolloClient2(options) {
      ...
      var uri = options.uri, credentials = options.credentials, headers = options.headers, cache = options.cache, documentTransform = options.documentTransform, _b = options.ssrMode, ssrMode = _b === void 0 ? false : _b, _c = options.ssrForceFetchDelay, ssrForceFetchDelay = _c === void 0 ? 0 : _c, connectToDevTools = options.connectToDevTools, _d = options.queryDeduplication, queryDeduplication = _d === void 0 ? true : _d, defaultOptions2 = options.defaultOptions, defaultContext = options.defaultContext, _e = options.assumeImmutableResults, assumeImmutableResults = _e === void 0 ? cache.assumeImmutableResults : _e, resolvers = options.resolvers, typeDefs = options.typeDefs, fragmentMatcher = options.fragmentMatcher, clientAwarenessName = options.name, clientAwarenessVersion = options.version, devtools = options.devtools;
...
//# sourceMappingURL=chunk-GURKT67U.js.map
